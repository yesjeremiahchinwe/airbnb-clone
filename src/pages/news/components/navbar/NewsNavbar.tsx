...
import classes from "./news-nav.module.scss";
...
const NewsNavbar = () => {
  ...
  return (
    <>
      <section className={classes["news-header"]}>
        <div className={classes["header-wrapper"]}>
          ...
          <div
            className={classes["hambuger_menu"]}
          ...
          <div className={classes["top-right-corner"]}>
            ...
            <span>
              <TbWorld size={20} />
              <BiChevronDown size={30} color="#222222" />
            </span>
      ...
      <div
        className={`
      ${classes["mobile_menu_navigation"]} 
      ${isOpen ? classes["opened"] : ""}
      `}
      >
        <div className={classes["close_menu"]} onClick={() => setIsOpen(false)}>
          <IoMdClose size={30} />
        </div>
